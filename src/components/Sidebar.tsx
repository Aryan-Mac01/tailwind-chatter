...
import { User, Home, MessageSquare, Settings, Search, Bell } from 'lucide-react';
...
const Sidebar = () => {
  ...
  const handleTabChange = (value: string) => {
    setActiveTab(value as 'people' | 'groups');
  };
  ...
  return (
    <aside className="w-80 border-r border-border h-full flex flex-col bg-white">
